    ...
    fn build(&self, app: &mut App) {
      ...
      app.add_event::<EditRegionEvent>();
       ...
       app.add_event::<RegionBrushEvent>();
        app.add_systems(Update, apply_region_edits); //put this in a sub plugin ?
...
pub fn apply_command_events(
   ...
   // mut chunk_query: Query<(&Chunk, &mut ChunkData, &Parent, &Children)>, //chunks parent should have terrain data
    ...
    mut region_maps_res: ResMut<RegionsMapResource>,
...
pub fn apply_tool_edits(
    ...
    mut chunk_height_maps: ResMut<RegionsMapResource>,
                                                    ...
                                                    == TextureFormat::Rgba8UnormSrgb
                                            {
                                                            ...
                                                            + chunk_dimensions.y() as f32
                                                {
                                                    ...
                                                    if x < img_size.x && y < img_size.y {
                                                        ...
                                                        evt_writer.send(
                                                            RegionBrushEvent::EyeDropSplatMap {
                                                                r,
                                                                g,
                                                                b,
                                                            },
